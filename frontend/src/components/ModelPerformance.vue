            ...
            this.$nextTick(() => {
                ...
                for (let i = 0; i < data.length; i++) {
                    for (let j = 0; j < data[i].length; j++) {
                        svg.datum(data[i][j])
                            .append("rect")
                            .attr("x", function () { return x(j) })
                            .attr("y", function () { return y(i) })
                        ...
                        svg.datum(data[i][j])
                            .append("text")
                            .attr("x", function () { return (x(j)+x.bandwidth()/2) })
                            .attr("y", function () { return (y(i)+y.bandwidth()/2) })
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    svg.datum(type[i])
                        .append("text")
                        .attr("x", function () { return (x(i)+x.bandwidth()/2) })
